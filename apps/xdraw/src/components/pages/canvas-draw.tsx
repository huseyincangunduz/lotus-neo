...
export class CanvasDraw extends NeolitComponent {
    ...
    private downloadProject(): void {
        ...
        this.triggerDownload(
            serialized,
            this.createDownloadName("xdraw.json"),
    ...
    private async openProjectFromFile(): Promise<void> {
        ...
        input.onchange = async () => {
            ...
            try {
                ...
                alert(
                    "Dosya acilamadi. Lutfen gecerli bir XDraw dosyasi secin.",
                );
            }
        };
    ...
    onInit(): void {
        ...
        this.svgHolder.setBackgroundPattern(this.settings.backgroundPatternMode.get());
    ...
    private getPointerOffsetFromEvent(
            ...
            <div className="flex flex-row gap-2 p-2 h-[100dvh] w-[100dvw] overflow-hidden box-border">
                <div>
                    <CanvasDrawSidebar
                        ...
                        pushHistorySnapshotOperation={this.pushHistorySnapshotOperation.bind(this)}
                    ></CanvasDrawSidebar>
                </div>
                <div
